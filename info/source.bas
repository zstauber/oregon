 ...
 660 RPINT "WHEN ASKED TO ENTER MONEY AMOUNTS, DON'T USE A ""$""."
 670 PRINT
 680 PRINT "GOOD LUCK!!!"
 690 PRINT
 700 PRINT
 ...
 750 PRINT "FASTER YOU'LL HAEV TO BE WITH YORU GUN TO BE SUCCESSFUL."
 760 INPUT D9
...
1300 ON D0-10 GOTO 1510,1530,1550,1570,1590,1610,1630,1650,1670,1690
1310 PRINT "APRIL 12 ";
1320 GOT0 1720
1330 PRINT "APRIL 26 ";
1340 GOTO 1720
...
1680 GOTO 1720
1690 PRINT "YOU HAVE BEEN ON THE TRIAL TOO LONG  ------"
1700 PRINT "YOUR FAMILY DIES IN THE FIRST BLIZZAD OF WINTER"
1710 GOTO 5170
1720 PRINT "1547"
1730 PRINT
...
2010 GOTO 2040
2020 PRINT "TOTAL MILEATE IS 950"
2030 M9=0
2040 PRINT "FOOD","BULLETS","CLOTHING","MISC. SUPP.","CASH"
2040 PRINT F,B,C,M1,T
...
3150 PRINT "NICE SHOOTING---YOU DRIVE THEM OFF"
3160 GOTO 3470
...
4720 IF RND(-1)*10>9-((M/100-15)**2+72)/((M/10015)**2+12) THEN 4860
