...
2375 PRINT "YOU MISS YOUR CHANGE TO SPEND ON THAT ITEM"
2380 T=T+P
2390 P=0
2400 RETURN
2410 F=F+2/3*P
...
REM 2600 IF 100*RND(-1)<13*B1 THEN 2710
...
REM 2680 F=F+52+RND(-1)*6
2680 F=F+52+RND(1)*6
REM 2690 B=B-10-RND(-1)*4
2690 B=B-10-RND(1)*4
2700 GOTO 2720
...
REM 3250 IF RND(-1)>.5 THEN 3450
3250 IF RND(1)>.8 THEN 345
3260 LET B=B-150
3270 M1=M1-15
3280 GOTO 3470
3290 GOSUB 6140
...
REM 3760 M=M-5-4*RND(-1)
3760 M=M-5-4*RND(1)
REM 3770 M1=M1-2-3*RND(-1)
...
REM 4500 IF C>22+4*RND(-1) THEN 4530
...
REM 4570 M=M-5-RND(-1)*10
4570 M=M-5-RND(1)*10
4580 B=B-200
REM 4590 M1=M1-4-RND(-1)*3
4590 M1=M1-4-RND(1)*3
4600 GOTO 4710
4610 IF E=1 THEN 6300
4620 IF E=3 THEN 4650
REM 4630 IF RND(-1)>.25 THEN 6300
4630 IF RND(1)>.25 THEN 6300
4640 GOTO 4710
REM 4650 IF RND(-1)<.5 THEN 6300
...
5000 M1=M1-10
5010 B=B-300
REM 5020 M=M-30-40*RND(-1)
5020 M=M-30-40*RND(1)
REM 5030 IF C<18+2*RND(-1) THEN 6300
...
5240 INPUT C$
5250 PRINT "WOULD YOU LKE US TO INFORM YOUR NEXT OF KIN?"
5260 INPUT C$
...
6170 S$(3)="POW"
6180 S$(4)="WHAM"
REM 6190 S6=INT(RND(-1)*4+1)
6190 S6=INT(RND(1)*4+1)
6200 PRINT "TYPE "; S$(S6)
REM 6210 B3 = CLK(0)
6210 B3 = TIMER
6220 INPUT C$
REM https://archive.org/stream/bitsavers_cdccyberlaICVersion3ReferenceManualAug84_55523426/19983900K_BASIC_Version_3_Reference_Manual_Aug84_djvu.txt
REM ON THE CDC CYBER 70, THE CLK(0) FUNCTION RETURNS THE DAYTIME IN FRACTIONAL
REM HOURS FROM MIDNIGHT.  SO 12H:40M:43S WOULD BE LISTED AS 12.6786.  THEREFORE
REM MULTIPLYING THE DIFFERENCE OF TWO SYSTEM TIMES BY 3600 AS IN LINE 6240 IS
REM INTENDED TO RETURN THE TIME ELAPSED IN SECONDS.  SO THAT IS WHAT WE'LL DO  
REM 6230 B1 = CLK(0)
6230 B1 = TIMER
REM 6240 B1=((B1-B3)*3600)-(D9-1)
6240 B1=(B1-B3)-(D9-1)
6250 PRINT
...
REM 6300 IF 100*RND(-1)<10+35*(E-1) THEN 6370
6300 IF 100*RND(1)<10+35*(E-1) THEN 6370
REM 6310 IF 100*RND(-1)<100-(40/4**(E-1)) THEN 6410
...
6800 END
7000 REM PRINT OUT ALL VARIABLES FOR DEBUGGING PURPOSES
7010 PRINT "A:";A;TAB(8);"B:";B;TAB(16);"B1:";B1;TAB(24);"B3:";B3;TAB(32);"C:";C;TAB(40);"C1:";C1;TAB(48);"C$:";C$;TAB(56);"D1:";D1;TAB(64);"D3:";D3;TAB(72);"D4:";D4;""
7020 PRINT "D9:";D9;TAB(8);"E:";E;TAB(16);"F:";F;TAB(24);"F1:";F1;TAB(32);"F2:";F2;TAB(40);"F9:";F9;TAB(48);"K8:";K8;TAB(56);"L1:";L1;TAB(64);"M:";M;TAB(72);"M1:";M1;""
7030 PRINT "M2:";M2;TAB(8);"M9:";M9;TAB(16);"P:";P;TAB(24);"R1:";R1;TAB(32);"S4:";S4;TAB(40);"S5:";S5;TAB(48);"S6:";S6;TAB(56);"S$:";S$;TAB(64);"T:";T;TAB(72);"T1:";T1;""
7040 PRINT "X:";X;TAB(8);"X1:";X1;""
7050 RETURN
